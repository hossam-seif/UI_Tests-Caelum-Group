...
namespace Web_Tests
{
    public static partial class ExtensionMethods
    {
        ...
        /// </summary>
        /// <param name="_WebDriver">* this WebDriver have elements</param>
        ...
        /// </summary>
        /// <param name="_WebDriver">* WebDriver </param>
       ...
       // public static void Screenshot(this IWebDriver _WebDriver, string _path = null, string _filename = "Screenshot")
        //{

          //  FrameworkExtendMethods.DriverScreenshot(_WebDriver, string.IsNullOrWhiteSpace(_path) ? FrameworkBase.Globalscreenshootpath : _path, _filename);
       // }
        ...
        public static void DDLbyText(this IWebElement _element, string value, bool _partialMatch = false, FrameworkExtendMethods.SelectorType _selectorType = FrameworkExtendMethods.SelectorType.select, string _classname = "", string _tagname = "a")
        {
            FrameworkExtendMethods.SelectfromDDLbyText(_element, value, _partialMatch, _selectorType, _classname, _tagname);
        }
        /// <summary>
        /// FUN() to upload file 
        /// </summary>
        /// <param name="_path"> absolute file path</param>
        public static void Uploadfile(this IWebElement _element, string _path = null)
        {
            FrameworkExtendMethods.UploadfileStream(_element, string.IsNullOrWhiteSpace(_path) ? FrameworkBase.Globalexportpath : _path);
        }
    }
}
